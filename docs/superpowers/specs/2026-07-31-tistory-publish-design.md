...
> **⚠️ 폐기됨 (2026-07-31)**: 구현 완료 후 실사용 테스트 직전, Tistory Open API가 2024년 2월까지 순차 종료된 사실을 확인했다. 글쓰기 API를 포함한 핵심 기능이 종료 대상이라 이 설계로는 실제 발행이 불가능하다. dev.to로 대체 — [`2026-07-31-devto-publish-design.md`](2026-07-31-devto-publish-design.md) 참고.
